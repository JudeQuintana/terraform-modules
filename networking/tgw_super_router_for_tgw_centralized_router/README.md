...
| <a name="input_super_router"></a> [super\_router](#input\_super\_router) | Super Router configuration | <pre>object({<br>    name            = string<br>    blackhole_cidrs = optional(list(string), [])<br>    local = object({<br>      amazon_side_asn = number<br>      centralized_routers = optional(map(object({<br>        account_id        = string<br>        amazon_side_asn   = string<br>        full_name         = string<br>        id                = string<br>        region            = string<br>        route_table_id    = string<br>        vpc_network_cidrs = list(string)<br>        vpc_routes = list(object({<br>          route_table_id         = string<br>          destination_cidr_block = string<br>          transit_gateway_id     = string<br>        }))<br>        vpcs = map(object({<br>          network_cidr                 = string<br>          az_to_public_route_table_id  = map(string)<br>          az_to_private_route_table_id = map(string)<br>        }))<br>      })), {})<br>    })<br>    peer = object({<br>      amazon_side_asn = number<br>      centralized_routers = optional(map(object({<br>        account_id        = string<br>        amazon_side_asn   = string<br>        full_name         = string<br>        id                = string<br>        region            = string<br>        route_table_id    = string<br>        vpc_network_cidrs = list(string)<br>        vpc_routes = list(object({<br>          route_table_id         = string<br>          destination_cidr_block = string<br>          transit_gateway_id     = string<br>        }))<br>        vpcs = map(object({<br>          network_cidr                 = string<br>          az_to_public_route_table_id  = map(string)<br>          az_to_private_route_table_id = map(string)<br>        }))<br>      })), {})<br>    })<br>  })</pre> | n/a | yes |
