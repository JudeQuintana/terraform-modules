locals {
  ...
  local_vpc_route_table_ids = concat(var.vpc_peering.local.vpc.private_route_table_ids, var.vpc_peering.local.vpc.public_route_table_ids)
  local_vpc_subnet_cidrs    = concat(var.vpc_peering.local.vpc.private_subnet_cidrs, var.vpc_peering.local.vpc.public_subnet_cidrs)

  peer_route_table_ids  = concat(var.vpc_peering.peer.vpc.private_route_table_ids, var.vpc_peering.peer.vpc.public_route_table_ids)
  peer_vpc_subnet_cidrs = concat(var.vpc_peering.peer.vpc.private_subnet_cidrs, var.vpc_peering.peer.vpc.public_subnet_cidrs)
