locals {
  ...
  local_vpc_subnet_cidrs    = concat(var.vpc_peering.local.vpc.private_subnet_cidrs, var.vpc_peering_deluxe.local.vpc.public_subnet_cidrs)
  ...
  peer_vpc_subnet_cidrs = concat(var.vpc_peering_deluxe.peer.vpc.private_subnet_cidrs, var.vpc_peering_deluxe.peer.vpc.public_subnet_cidrs)
