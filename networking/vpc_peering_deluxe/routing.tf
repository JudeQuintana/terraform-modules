locals {
  ...
  local_vpc_ipv6_subnet_cidrs = local.only_route_ipv6_subnet_cidrs ? toset(var.vpc_peering_deluxe.local.only_route_subnet_cidrs) : toset(concat(var.vpc_peering_deluxe.local.vpc.private_ipv6_subnet_cidrs, var.vpc_peering_deluxe.local.vpc.public_ipv6_subnet_cidrs)) # dont need compact()
  ...
  local_vpc_ipv6_routes_to_peer_vpc_ipv6_subnet_cidrs = [
    for local_vpc_route_table_id_and_peer_vpc_ipv6_subnet_cidr in setproduct(local.local_vpc_route_table_ids, local.peer_vpc_ipv6_subnet_cidrs) : {
      ...
      destination_cidr_block = local_vpc_route_table_id_and_peer_vpc_ipv6_subnet_cidr[1]
  }]
