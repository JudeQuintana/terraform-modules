...
locals {
  ...
  one_vpc_id_to_two_inbound_ipv6_network_cidrs = {
    for vpc_id_and_ipv6_network_cidr in setproduct(keys(local.one_vpc_id_to_ipv6_network_cidr), values(local.two_vpc_id_to_ipv6_network_cidr)) :
    vpc_id_and_ipv6_network_cidr[0] => vpc_id_and_ipv6_network_cidr[1]...
    if lookup(local.one_vpc_id_to_ipv6_network_cidr, vpc_id_and_ipv6_network_cidr[0]) != vpc_id_and_ipv6_network_cidr[1]
  }

  one_vpc_id_to_three_inbound_ipv6_network_cidrs = {
    for vpc_id_and_ipv6_network_cidr in setproduct(keys(local.one_vpc_id_to_ipv6_network_cidr), values(local.three_vpc_id_to_ipv6_network_cidr)) :
    vpc_id_and_ipv6_network_cidr[0] => vpc_id_and_ipv6_network_cidr[1]...
    if lookup(local.one_vpc_id_to_ipv6_network_cidr, vpc_id_and_ipv6_network_cidr[0]) != vpc_id_and_ipv6_network_cidr[1]
  }

  two_vpc_id_to_one_inbound_ipv6_network_cidrs = {
    for vpc_id_and_ipv6_network_cidr in setproduct(keys(local.two_vpc_id_to_ipv6_network_cidr), values(local.one_vpc_id_to_ipv6_network_cidr)) :
    vpc_id_and_ipv6_network_cidr[0] => vpc_id_and_ipv6_network_cidr[1]...
    if lookup(local.two_vpc_id_to_ipv6_network_cidr, vpc_id_and_ipv6_network_cidr[0]) != vpc_id_and_ipv6_network_cidr[1]
  }

  two_vpc_id_to_three_inbound_ipv6_network_cidrs = {
    for vpc_id_and_ipv6_network_cidr in setproduct(keys(local.two_vpc_id_to_ipv6_network_cidr), values(local.three_vpc_id_to_ipv6_network_cidr)) :
    vpc_id_and_ipv6_network_cidr[0] => vpc_id_and_ipv6_network_cidr[1]...
    if lookup(local.two_vpc_id_to_ipv6_network_cidr, vpc_id_and_ipv6_network_cidr[0]) != vpc_id_and_ipv6_network_cidr[1]
  }

  three_vpc_id_to_one_inbound_ipv6_network_cidrs = {
    for vpc_id_and_ipv6_network_cidr in setproduct(keys(local.three_vpc_id_to_ipv6_network_cidr), values(local.one_vpc_id_to_ipv6_network_cidr)) :
    vpc_id_and_ipv6_network_cidr[0] => vpc_id_and_ipv6_network_cidr[1]...
    if lookup(local.three_vpc_id_to_ipv6_network_cidr, vpc_id_and_ipv6_network_cidr[0]) != vpc_id_and_ipv6_network_cidr[1]
  }

  three_vpc_id_to_two_inbound_ipv6_network_cidrs = {
    for vpc_id_and_ipv6_network_cidr in setproduct(keys(local.three_vpc_id_to_ipv6_network_cidr), values(local.two_vpc_id_to_ipv6_network_cidr)) :
    vpc_id_and_ipv6_network_cidr[0] => vpc_id_and_ipv6_network_cidr[1]...
    if lookup(local.three_vpc_id_to_ipv6_network_cidr, vpc_id_and_ipv6_network_cidr[0]) != vpc_id_and_ipv6_network_cidr[1]
  }

  one_rules   = [for this in var.ipv6_full_mesh_intra_vpc_security_group_rules.one.intra_vpc_security_group_rules : this.rule]
  two_rules   = [for this in var.ipv6_full_mesh_intra_vpc_security_group_rules.two.intra_vpc_security_group_rules : this.rule]
  three_rules = [for this in var.ipv6_full_mesh_intra_vpc_security_group_rules.three.intra_vpc_security_group_rules : this.rule]
  ...
  one_vpc_id_and_rule_to_two_intra_vpc_security_group_rule = merge([
    for this in local.two_rules : {
      ...
      format(local.intra_vpc_security_group_rules_format, vpc_id, this.protocol, this.from_port, this.to_port) => merge({
        ...
        ipv6_network_cidrs          = inbound_ipv6_network_cidrs
