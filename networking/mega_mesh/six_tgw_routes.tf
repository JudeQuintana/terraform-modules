...
resource "aws_ec2_transit_gateway_route" "this_six_tgw_routes_to_vpcs_in_seven_tgw" {
  provider = aws.six
...
resource "aws_ec2_transit_gateway_route" "this_six_tgw_routes_to_vpcs_in_eight_tgw" {
  provider = aws.six
...
resource "aws_ec2_transit_gateway_route" "this_six_tgw_routes_to_vpcs_in_nine_tgw" {
  provider = aws.six
...
resource "aws_ec2_transit_gateway_route" "this_six_tgw_routes_to_vpcs_in_ten_tgw" {
  provider = aws.six
