...
resource "aws_ec2_transit_gateway_route_table_association" "this_six_to_this_seven" {
  provider = aws.six
...
resource "aws_ec2_transit_gateway_route_table_association" "this_six_to_this_eight" {
  provider = aws.six
...
resource "aws_ec2_transit_gateway_route_table_association" "this_six_to_this_nine" {
  provider = aws.six
...
resource "aws_ec2_transit_gateway_route_table_association" "this_six_to_this_ten" {
  provider = aws.six
