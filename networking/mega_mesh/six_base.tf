...
locals {
  ...
  six_tgw_vpc_network_cidrs      = toset(concat(local.six_tgw.vpc.network_cidrs, local.six_tgw.vpc.secondary_cidrs))
  six_tgw_vpc_ipv6_network_cidrs = toset(cocnat(local.six_tgw.vpc.ipv6_network_cidrs, local.six_tgw.vpc.ipv6_secondary_cidrs))
