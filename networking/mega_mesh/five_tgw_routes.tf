...
resource "aws_ec2_transit_gateway_route" "this_five_tgw_routes_to_vpcs_in_eight_tgw" {
  provider = aws.five
...
resource "aws_ec2_transit_gateway_route" "this_five_tgw_routes_to_vpcs_in_nine_tgw" {
  provider = aws.five
...
resource "aws_ec2_transit_gateway_route" "this_five_tgw_routes_to_vpcs_in_ten_tgw" {
  provider = aws.five
...
# ipv6
resource "aws_ec2_transit_gateway_route" "this_five_tgw_ipv6_routes_to_vpcs_in_one_tgw" {
  provider = aws.five
...
resource "aws_ec2_transit_gateway_route" "this_five_tgw_ipv6_routes_to_vpcs_in_two_tgw" {
  provider = aws.five
...
resource "aws_ec2_transit_gateway_route" "this_five_tgw_ipv6_routes_to_vpcs_in_three_tgw" {
  provider = aws.five
...
resource "aws_ec2_transit_gateway_route" "this_five_tgw_ipv6_routes_to_vpcs_in_four_tgw" {
  provider = aws.five
...
resource "aws_ec2_transit_gateway_route" "this_five_tgw_ipv6_routes_to_vpcs_in_six_tgw" {
  provider = aws.five
...
resource "aws_ec2_transit_gateway_route" "this_five_tgw_ipv6_routes_to_vpcs_in_seven_tgw" {
  provider = aws.five
...
resource "aws_ec2_transit_gateway_route" "this_five_tgw_ipv6_routes_to_vpcs_in_eight_tgw" {
  provider = aws.five

  for_each = local.eight_tgw_vpc_ipv6_network_cidrs
...
resource "aws_ec2_transit_gateway_route" "this_five_tgw_ipv6_routes_to_vpcs_in_nine_tgw" {
  provider = aws.five
...
resource "aws_ec2_transit_gateway_route" "this_five_tgw_ipv6_routes_to_vpcs_in_ten_tgw" {
  provider = aws.five
