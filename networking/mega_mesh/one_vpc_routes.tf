...
locals {
  ...
  one_tgw_new_vpc_routes_to_seven_tgw_vpcs = {
    for this in local.one_vpc_routes_to_seven_tgw_vpcs :
    format(local.route_format, this.route_table_id, this.destination_cidr_block) => this
  }
}

resource "aws_route" "this_one_vpc_routes_to_seven_tgw_vpcs" {
  provider = aws.one

  for_each = local.one_tgw_new_vpc_routes_to_seven_tgw_vpcs
...
locals {
  ...
  one_tgw_new_vpc_routes_to_eight_tgw_vpcs = {
    for this in local.one_vpc_routes_to_eight_tgw_vpcs :
    format(local.route_format, this.route_table_id, this.destination_cidr_block) => this
  }
}

resource "aws_route" "this_one_vpc_routes_to_eight_tgw_vpcs" {
  provider = aws.one

  for_each = local.one_tgw_new_vpc_routes_to_eight_tgw_vpcs
...
locals {
  ...
  one_tgw_new_vpc_routes_to_nine_tgw_vpcs = {
    for this in local.one_vpc_routes_to_nine_tgw_vpcs :
    format(local.route_format, this.route_table_id, this.destination_cidr_block) => this
  }
}

resource "aws_route" "this_one_vpc_routes_to_nine_tgw_vpcs" {
  provider = aws.one

  for_each = local.one_tgw_new_vpc_routes_to_nine_tgw_vpcs
...
locals {
  ...
  one_tgw_new_vpc_routes_to_ten_tgw_vpcs = {
    for this in local.one_vpc_routes_to_ten_tgw_vpcs :
    format(local.route_format, this.route_table_id, this.destination_cidr_block) => this
  }
}

resource "aws_route" "this_one_vpc_routes_to_ten_tgw_vpcs" {
  provider = aws.one

  for_each = local.one_tgw_new_vpc_routes_to_ten_tgw_vpcs
