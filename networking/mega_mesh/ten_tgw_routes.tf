# ten
resource "aws_ec2_transit_gateway_route" "this_ten_tgw_routes_to_vpcs_in_one_tgw" {
  provider = aws.ten

  for_each = local.one_tgw_vpc_network_cidrs

  transit_gateway_route_table_id = local.ten_tgw.route_table_id
  destination_cidr_block         = each.value
  transit_gateway_attachment_id  = aws_ec2_transit_gateway_peering_attachment_accepter.this_ten_to_this_one.id
}

resource "aws_ec2_transit_gateway_route" "this_ten_tgw_routes_to_vpcs_in_two_tgw" {
  provider = aws.ten
...
resource "aws_ec2_transit_gateway_route" "this_ten_tgw_routes_to_vpcs_in_three_tgw" {
  provider = aws.ten
...
resource "aws_ec2_transit_gateway_route" "this_ten_tgw_routes_to_vpcs_in_four_tgw" {
  provider = aws.ten
...
resource "aws_ec2_transit_gateway_route" "this_ten_tgw_routes_to_vpcs_in_five_tgw" {
  provider = aws.ten
...
resource "aws_ec2_transit_gateway_route" "this_ten_tgw_routes_to_vpcs_in_six_tgw" {
  provider = aws.ten
  ...
  transit_gateway_route_table_id = local.ten_tgw.route_table_id
  destination_cidr_block         = each.value
  transit_gateway_attachment_id  = aws_ec2_transit_gateway_peering_attachment_accepter.this_ten_to_this_six.id
}

resource "aws_ec2_transit_gateway_route" "this_ten_tgw_routes_to_vpcs_in_seven_tgw" {
  provider = aws.ten
...
resource "aws_ec2_transit_gateway_route" "this_ten_tgw_routes_to_vpcs_in_eight_tgw" {
  provider = aws.ten
...
resource "aws_ec2_transit_gateway_route" "this_ten_tgw_routes_to_vpcs_in_nine_tgw" {
  provider = aws.ten
