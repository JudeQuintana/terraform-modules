# seven
resource "aws_ec2_transit_gateway_route_table_association" "this_seven_to_this_one" {
  provider = aws.seven
...
resource "aws_ec2_transit_gateway_route_table_association" "this_seven_to_this_two" {
  provider = aws.seven
...
resource "aws_ec2_transit_gateway_route_table_association" "this_seven_to_this_three" {
  provider = aws.seven
...
resource "aws_ec2_transit_gateway_route_table_association" "this_seven_to_this_four" {
  provider = aws.seven
...
resource "aws_ec2_transit_gateway_route_table_association" "this_seven_to_this_five" {
  provider = aws.seven
...
resource "aws_ec2_transit_gateway_route_table_association" "this_seven_to_this_six" {
  provider = aws.seven
...
resource "aws_ec2_transit_gateway_route_table_association" "this_seven_to_this_eight" {
  provider = aws.seven
...
resource "aws_ec2_transit_gateway_route_table_association" "this_seven_to_this_nine" {
  provider = aws.seven
...
resource "aws_ec2_transit_gateway_route_table_association" "this_seven_to_this_ten" {
  provider = aws.seven
