...
resource "aws_ec2_transit_gateway_route" "this_four_tgw_routes_to_vpcs_in_eight_tgw" {
  provider = aws.four
...
resource "aws_ec2_transit_gateway_route" "this_four_tgw_routes_to_vpcs_in_nine_tgw" {
  provider = aws.four
...
resource "aws_ec2_transit_gateway_route" "this_four_tgw_routes_to_vpcs_in_ten_tgw" {
  provider = aws.four
