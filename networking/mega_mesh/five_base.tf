...
locals {
  ...
  five_tgw_vpc_network_cidrs      = toset(concat(local.five_tgw.vpc.network_cidrs, local.five_tgw.vpc.secondary_cidrs))
  five_tgw_vpc_ipv6_network_cidrs = toset(cocnat(local.five_tgw.vpc.ipv6_network_cidrs, local.five_tgw.vpc.ipv6_secondary_cidrs))
