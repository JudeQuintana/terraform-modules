...
resource "aws_ec2_transit_gateway_route" "this_one_tgw_routes_to_vpcs_in_eight_tgw" {
  provider = aws.one
...
resource "aws_ec2_transit_gateway_route" "this_one_tgw_routes_to_vpcs_in_nine_tgw" {
  provider = aws.one
...
resource "aws_ec2_transit_gateway_route" "this_one_tgw_routes_to_vpcs_in_ten_tgw" {
  provider = aws.one
