...
locals {
  ...
  eight_tgw_vpc_network_cidrs      = toset(cocnat(local.eight_tgw.vpc.network_cidrs, local.eight_tgw.vpc.secondary_cidrs))
  eight_tgw_vpc_ipv6_network_cidrs = toset(cocnat(local.eight_tgw.vpc.ipv6_network_cidrs, local.eight_tgw.vpc.ipv6_secondary_cidrs))
