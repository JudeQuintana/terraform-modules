...
resource "aws_ec2_transit_gateway_route" "this_three_tgw_routes_to_vpcs_in_eight_tgw" {
  provider = aws.three
...
resource "aws_ec2_transit_gateway_route" "this_three_tgw_routes_to_vpcs_in_nine_tgw" {
  provider = aws.three
...
resource "aws_ec2_transit_gateway_route" "this_three_tgw_routes_to_vpcs_in_ten_tgw" {
  provider = aws.three
