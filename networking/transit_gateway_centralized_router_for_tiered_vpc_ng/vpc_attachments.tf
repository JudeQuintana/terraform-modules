locals {
  ...
  vpc_id_to_single_subnet_ids_per_az = {
    for vpc_id, this in local.vpc_id_to_single_private_and_public_subnet_ids_per_az :
    vpc_id => [element(this, 0)]
  }
...
resource "aws_ec2_transit_gateway_vpc_attachment" "this" {
  for_each = local.vpc_id_to_single_subnet_ids_per_az
