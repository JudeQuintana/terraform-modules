...
locals {
  ...
  public_any_ipv6_subnet_exists          = length(local.public_ipv6_subnet_cidrs) > 0
  ...
  public_ipv6_route_out                  = { for this in [local.public_any_ipv6_subnet_exists] : this => this if local.public_any_ipv6_subnet_exists }
}
