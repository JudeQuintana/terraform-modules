locals {
  ...
  public_natgw_az_to_subnet_cidr    = merge([for az, this in var.tiered_vpc.azs : { for public_subnet in this.public_subnets : az => public_subnet.cidr if public_subnet.natgw } if !local.private_ipv4_centralized_egress_opt_in]...)
